...
public class Server4 extends JFrame {
    ...
    public Server4() {
        JFrame mainFrm = new JFrame("Server 4");
        ...
        scroll.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue, 2), "SERVER 4", TitledBorder.CENTER, TitledBorder.CENTER, new Font("Dialog", Font.BOLD, 12), Color.blue));
    ...
    public static class sv4 implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                gs.getCurrentCircle();
                gs.sendUpdate("127.0.0.1", 2005, "Server4");

                ServerSocket server = new ServerSocket(2004);
                while (true) {
                    int localPort = server.getLocalPort();
                    display.append("Server 4 is listening on port " + localPort + ".\n");
