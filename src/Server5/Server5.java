...
public class Server5 extends JFrame {
    ...
    public Server5() {
        JFrame mainFrm = new JFrame("Server 5");
        ...
        scroll.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue, 2), "SERVER 5", TitledBorder.CENTER, TitledBorder.CENTER, new Font("Dialog", Font.BOLD, 12), Color.blue));
    ...
    public static class sv5 implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                gs.getCurrentCircle();
                gs.sendUpdate("127.0.0.1", 2001, "Server5");

                ServerSocket server = new ServerSocket(2005);
                while (true) {
                    int localPort = server.getLocalPort();
                    display.append("Server 5 is listening on port " + localPort + ".\n");
