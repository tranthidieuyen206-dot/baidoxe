...
//                        String address1 = "235.0.0.1";
//                        String address2 = "235.255.0.1";
//                        String addresStr[] = {address, address1, address2};
//
//                        InetAddress add1 = InetAddress.getByName(address1);
//                        socketU.joinGroup(add1);
//                        InetAddress add2 = InetAddress.getByName(address2);
//                        socketU.joinGroup(add2);
//                        InetAddress str[] = {add, add1, add2};
//
//                        //Send information to multiServer
//                        for (int j = 1; j < str.length; j++) {
//                            String mes = "!round";
//                            byte messages[] = mes.getBytes();
//                            DatagramPacket packetR = new DatagramPacket(messages, messages.length, str[j], portM);
//                            socketU.send(packetR);
//                        }
//                    } else {
//                        ch = temp.split("-");
//                        lp = Integer.parseInt(ch[0]);
//                    }
                    display.append(temp + "\n");
//                    check = true;
...
//                        //Send information to multiServer
//                        for (int j = 1; j < str.length; j++) {
//                            String mes = lp + "-success ";
//                            byte messages[] = mes.getBytes();
//                            DatagramPacket packetR = new DatagramPacket(messages, messages.length, str[j], portM);
//                            socketU.send(packetR);
//                        }
//                    } else {
//                        //int client_portM = packet.getportM();
//                        //System.out.println("Received : '" + dataReceive + "' from  i= " + i +"\n");
//                    }
                }
            } catch (IOException e) {
                //System.err.println(e);
...
//                while (true) {
//                    /*
//                     * String address = "224.0.0.0"; socket = new
//                     * MulticastSocket(portM); InetAddress add =
//                     * InetAddress.getByName(address); socket.joinGroup(add);
//                     */
//                    //System.out.println("DANG CHO NHAN LAMPORT...");
//                    // lay lamport tu UDPMulticastSever
//                    if (lamport.check == true) {
//                        lp = lamport.lamp();
//                        lamport.check = false;
//                        display.append("\nLAMPORT: " + lp + "\n");
//                    }
...
//                //th.sleep(1000);
//            } catch (Exception ex) {
//                display.append("Khong nhan duoc lamport");
//            }
        }
    }
